...
const segments = [
  ...
  { label: 'Capas de Chuva' },
];

export default function CapasDeChuvaPage() {
  const { slug } = useUnidade();
  const tipoData = tiposAcessorio.find((t) => t.slug === 'capas-de-chuva');
  ...
  function getLink(marcaNome: string) {
    ...
    return gerarLinkWhatsApp(numero, { produto: `Capa de Chuva ${marcaNome}` });
  }
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-10">
            ...
            {tipoData.marcas.map((marca) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 p-5 z-10">
                  ...
                  <span
                    className="vp-cta flex items-center gap-1.5 text-sm font-medium mt-2"
          ...
          <ConsultorCard produto="Capas de Chuva" />
        </div>
      </div>
    </div>
  );
